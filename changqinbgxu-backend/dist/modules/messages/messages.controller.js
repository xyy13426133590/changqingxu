...
let MessagesController = class MessagesController {
    ...
    async markRead(userId, markReadDto) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '发送消息（REST API 备选）' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: '发送成功' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: '标记消息已读' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: '标记成功' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, message_dto_1.MarkReadDto]),
    __metadata("design:returntype", Promise)
], MessagesController.prototype, "markRead", null);
exports.MessagesController = MessagesController = __decorate([
    (0, swagger_1.ApiTags)('消息'),
